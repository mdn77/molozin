        ...
        <div class="footer-grid">
            <div class="footer-col">
                ...
                <div class="social-links-text">
                    <a href="https://vk.com/mdn77" target="_blank" rel="noopener noreferrer" aria-label="VK">
                    ...
                    <a href="https://t.me/molozin" target="_blank" rel="noopener noreferrer" aria-label="Telegram">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                            <path
                    ...
                    <a href="https://wa.me/79234064441" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                            <path
