...
<?php
            ...
            if (empty($portfolio_items)) {
                ...
                $default_cases = [
                    ...
                    ['title' => 'KAMAKSIL | 3D-конструктор площадок', 'url' => 'https://kamaksil.ru/', 'image_url' => 'https://s0.wp.com/mshots/v1/https://kamaksil.ru/?w=600&h=450', 'description' => 'Интерактивный 3D-конструктор и визуализатор детских площадок КСИЛ. Каталог оборудования, коммерческие предложения, встраивание на внешние сайты.', 'tags' => 'WebGL, 3D-Терминал, КСИЛ', 'sort_order' => 10]
                ];
